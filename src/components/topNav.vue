        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <router-link class="nav-link" to="/home" v-if="userInfo">Home</router-link>
                    ...
                    <!--</li>-->
                    <li class="nav-item">
                        <router-link class="nav-link" to="/live-radio">Live Radio</router-link>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav ml-auto pt-2">
                    <li class="dropdown nav-item profile_nav" v-if="$store.state.userInfo">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false">
                            <img v-lazy="$store.state.userInfo.photo?$store.state.userInfo.photo:'../../../assets/img/blank_profile.png'" alt="" style="height: 30px;"
